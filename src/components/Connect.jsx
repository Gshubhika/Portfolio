...
const Connect = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.name || !formData.email || !formData.message) {
      alert("Please fill in your name, email, and message so we can connect!");
      return;
    }
    // Simulate submission
    setIsSubmitted(true);
    setTimeout(() => {
      ...
      setFormData({ name: '', project: 'a new website', email: '', message: '' });
    }, 5000);
  };
      ...
      <div className="layout-container">
        ...
        <div className="connect-header-wrapper">
          ...
          <h2 className="section-title">
            <span className="bubble-outline">Let's</span> <span className="font-serif">Connect</span>
          </h2>
        ...
        <div className="connect-body-grid">
          ...
          {/* Lined Letter Form */}
          <form onSubmit={handleSubmit} className="lined-paper connect-letter-form">
            <div className="paperclip-sticker" style={{ right: '40px', top: '-15px' }}>
            ...
            {isSubmitted ? (
              <div className="submitted-state flex-center flex-col py-10">
                ...
                <p className="font-hand text-lg text-slate-600">
                  Thanks for writing! I'll read your note and get back to you shortly.
                </p>
              </div>
            ) : (
              <div className="letter-sentence-structure font-hand">
                ...
                >
                  <option value="a new website">a new mobile/web product</option>
                  <option value="user research">doing user research</option>
                  <option value="a full-time opportunity">a full-time role</option>
                ...
                <div className="letter-footer flex-center mt-6">
                  <button type="submit" className="btn-scrapbook btn-scrapbook-blue">
                    Send Letter
          ...
          <div className="connect-sidebar">
            ...
            <div className="social-stickers-grid">
              ...
              <a 
                href="mailto:shubhika@uxdesigner.com" 
            ...
            <div className="scrapbook-disclaimer font-hand">
              ✦ Handcrafted with curiosity and coffee ✦ <br />
              © 2026 Shubhika Gupta. All rights reserved.
            </div>
          </div>
